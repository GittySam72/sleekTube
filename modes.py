...
def main(page: Page):
    ...
    def singleDownloader():
        if(downloadFormat.value == 'mp3'):
            try:
                ...
                single_video_length.value = str(int(yt.length / 60 )) + " Minute"
    ...
    Card(   
        ...
        Column(
            ...
            controls=[
                Container(
                    ...
                    content=Text(value="Video Details"),
        ...
        Column([
                Container(
                    content=Row([Container(
                    content=Text(value="Video Length"),
                    alignment=alignment.center,
                    width=200,
                    height=40,
                    bgcolor=colors.WHITE,
        ...
        Column([
                Container(
                    content=Row([Container(
                    content=Text(value="Video Quality"),
                    alignment=alignment.center,
                    width=200,
                    height=40,
                    bgcolor=colors.WHITE,
        ...
        Column([
                Container(
                    content=Row([Container(
                    content=Text(value="Video Format"),
                    alignment=alignment.center,
                    width=200,
                    height=40,
                    bgcolor=colors.WHITE,
        ...
        Column(
            ...
            controls=[
                Container(
                    content=Row([Container(
                    content=Text(value="Output Folder"),
                    alignment=alignment.center,
                    width=200,
                    height=40,
                    bgcolor=colors.WHITE,
    ...
    singleModeView = Column(
        ...
        controls=[
                ...
                #6
                Row([ElevatedButton(text="Download", on_click=downloadActionForSingle,icon="download")], alignment="center"),
    ...
    bulkViewMode = Column(
        ...
        controls=[
            #1
                Row([Text(value="Bulk Mode - Download whole channel or Playlist Video", style="headlineSmall")],alignment="center"),
                ...
                #7
                Row([ElevatedButton(text="Download", on_click=downloadActionForBulk,icon="download")], alignment="center"),
