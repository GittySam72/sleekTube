...
def main(page: Page):
    ...
    # **********************************************************
    # Common Variables and Functions across Views
    # --------------------------------------------
    def viewDecider(n):
        '''
        A function that decides which view is going to be displayed on page.
        '''
    ...
    # **********************************************************
    # Single Mode View variables and functions
    # --------------------------------------------
    ...
    def downloadActionForSingle(e):
        try:
            single_status_thumbnail.controls.clear()
            single_download_status.controls.clear()
            onSingleDownloadThread()
        except:
            onSingleDownloadThread()
    
    single_pr = ProgressBar()
    
    single_dlg = AlertDialog(
        title=Text("Parsing Data"), on_dismiss=lambda e: print("Dialog dismissed!"),
        content=single_pr
    )

    def single_viewDlg():
        page.dialog = single_dlg
        single_dlg.open = True
        page.update()
        sleep(3)
        single_dlg.open = False
        single_status.visible = True
        page.update()

    def onSingleDownloadThread():
        threading.Thread(target=single_viewDlg).start()
            ...
            try:
                ...
                single_status_thumbnail.controls.append(
                    Row(
                        ...
                        controls=[
                            Column([Text(str(cnt) + '  ' + u"\u27F6" + '   Downloading  ' + yt.title,width=500,font_family=default),
                ...
                single_status_thumbnail.update()
    ...
    # **********************************************************
    # Bulk Mode View variables and functions
    # --------------------------------------------
    ...
    # **********************************************************
    # Settings Mode View variables and functions
    # --------------------------------------------
